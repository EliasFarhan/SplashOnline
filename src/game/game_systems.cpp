...
Checksum<static_cast<int>(BulletChecksumIndex::LENGTH)+static_cast<int>(LENGTH)> GameSystems::CalculateChecksum() const
{
	Checksum<static_cast<int>(BulletChecksumIndex::LENGTH)+static_cast<int>(LENGTH)> gameSystemsChecksum{};
